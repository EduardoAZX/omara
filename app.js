/* =============================================================
   Dra. Omara — app.js
   Reveals on scroll · Máscara WhatsApp · Submit (placeholder) · FAQ
   ============================================================= */
(function () {
  'use strict';
  ...
  /* ---------- Submit (webhook Make) ---------- */
  // PLACEHOLDER: webhook herdado do template — substituir pelo webhook do Make/CRM da Dra. Omara
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      // validação simples
      var ok = true;
      ['nome', 'telefone', 'email'].forEach(function (id) {
      ...
      var sinalEl = document.getElementById('sinal');
      var sinalField = document.getElementById('sinalField');
      if (!sinalEl || !sinalEl.value) {
        if (sinalField) sinalField.classList.add('is-error');
        ok = false;
      } else if (sinalField) {
        sinalField.classList.remove('is-error');
      }
